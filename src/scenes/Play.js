class Play extends Phaser.Scene {
    ...
    create() {
      ...
      would be saying goodbye to Setsuko while he cremates her corpse. Setsuko is on the opposite \
      ...
      outcome of the game. This cycle would continue until the player decides to leave. \
      There is no winning. Setsuko is finally at peace.", playConfig).setOrigin(.5,0)

      // back to menu
      this.returnMenu = this.add.text(midW, midH + 200, "Click here to return to menu", playConfig).setOrigin(.5);
